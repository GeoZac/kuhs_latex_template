...
\usepackage{listings}
% to set page margins
\usepackage[top=2.58cm,bottom=2.58cm,right=2.58cm,left=2.58cm]{geometry}	
\usepackage{ragged2e}
\usepackage{setspace}
...
% For subequations support
\usepackage{amsmath}

\newcommand{\bigtab}{} 

% Required for probability representation
...
% Declare variables here, makes it referencing later, no need of changing every place it is used
...
\begin{center}
    ...
    \includegraphics[height=0.4\textwidth]{kuhs_logo}\par
    \vspace{0.5 cm}
...
\newgeometry{top=2.58cm,bottom=2.58cm,right=2.58cm,left=3.81cm}
...
\includegraphics[height=0.3\textwidth]{kuhs_logo}\par
...
\lipsum[2-4]We need figures for our reports so \prettyref{fig:somelabel} is added below\\ 
